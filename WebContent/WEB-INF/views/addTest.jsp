...
<div id="container">
		...
		<div id="systemContainer">
			...
			<div id="addNewItem">
				<form action="/SchoolManagement/saveTestPercent" method="post">
					<h4>ADD TEST PERCENT</h4>
					<div id="addData">
						<label for="percent">Add Test Percent</label>
						<input type="text" id="percent" name="testPercent" required="required"/>
						<label for="date">Date of EVP Test</label>
						<input type="text" name="date" id="date" placeholder="dd/MM/yyy"/>
						<input type="submit" value="Save Test Percent"/>
					</div>
				</form>
			</div>
		</div>
