...
<div id="container">
		...
		<div id="systemContainer">
			...
			<div id="addNewItem">
				<form action="/SchoolManagement/saveSessionPercent" method="post">
					<h4>ADD SESSION PERCENT</h4>
					<div id="addData">
						<label for="percent">Add Session Percent</label>
						<input type="text" id="percent" name="sessionPercent"  required="required"/>
						<label for="date">Date of Session</label>
						<input type="text" name="date" id="date" placeholder="dd/MM/yyy"/>
						<input type="submit" value="Save Session Percent"/>
					</div>
				</form>
			</div>
		</div>
