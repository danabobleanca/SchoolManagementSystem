	...
	<div id="container">
		...
		<div id="systemContainer">
			...
			<div id="contentSystem">
				<form action="/SchoolManagement/teacherOption" method="get">
				<div>
					<input type="submit" value="Add New Teacher" name="addTeacher"/>
					<input type="submit" value="View All Teachers" name="viewTeachers"/>
				</div>
				</form>
			</div>
		</div>
