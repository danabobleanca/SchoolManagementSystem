	...
	<div id="container">
		...
		<div id="systemContainer">
			...
			<div id="contentSystem">
				<form action="/SchoolManagement/courseOption" method="get">
				<div>
					<input type="submit" value="Add New Course" name="addCourse"/>
					<input type="submit" value="View All Courses" name="viewCourses"/>
				</div>
				</form>
			</div>
		</div>
